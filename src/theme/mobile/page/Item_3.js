        ...
        return (
            <div className={'gold'}>
                ...
                <div className={'gold-content'}>
                    ...
                    <div className={'gold-tips'}>Espresso Coffee #A by luckin coffee is awarded Gold Medal at the
                        International Coffee Tasting 2018 held in Milan by the International institute of Coffee Tasters
                        (IIAC).
                    </div>
                </div>
            </div>
